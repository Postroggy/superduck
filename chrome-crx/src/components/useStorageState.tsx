...
const microphoneWeights = new Map<string, React.ReactElement>([
  [
    'bold',
    React.createElement(
      React.Fragment,
...
// =============================================================================
// useStorageState hook (export u)
// =============================================================================

export function useStorageState<T>(key: string, defaultValue: T): [T, (value: T) => Promise<void>] {
...
// =============================================================================
// Exports (matching bundle: cu as X, au as m, uu as u)
// =============================================================================
